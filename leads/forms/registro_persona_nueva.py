...
class PersonaNuevaForm(forms.ModelForm):
    ...
    telefono_adicional_1 = forms.CharField(
        label="Teléfono Adicional 1", required=False,
        widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Opcional'})
    )
    telefono_adicional_2 = forms.CharField(
        label="Teléfono Adicional 2", required=False,
        widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Opcional'})
    )
    telefono_adicional_3 = forms.CharField(
        label="Teléfono Adicional 3", required=False,
        widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Opcional'})
    )
