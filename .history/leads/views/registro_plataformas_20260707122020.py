...
from ..models import Leads, UsuarioReporte, ReporteGrafico, Observaciones
...
def registro_plataformas(request, id_lead):
    ...
    if request.method == 'POST':
                ...
                with transaction.atomic():
                    ...
                    for prefijo in plataformas:
                        ...
                        if observacion_actual and nueva_obs:
                            ...
                            observacion_actual.save() # Sobrescribe el texto en la base de datos


                    return redirect('crear_acuerdo_pago', id_lead = lead_actual.id_lead )
        ...
        form = PlataformasReporteForm(initial={
            'observacion_general': texto_obs_existente
        })
