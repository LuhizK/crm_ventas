        ...
        if form.is_valid():
            try:
                with transaction.atomic():
                    ...
                    campos_extra = ['telefono_adicional_1', 'telefono_adicional_2', 'telefono_adicional_3']
                    
                    for campo in campos_extra:
                        tel_extra = form.cleaned_data.get(campo)
                        # Validamos que el asesor realmente haya escrito algo y no sean espacios en blanco
                        if tel_extra and tel_extra.strip():
                            Telefonos.objects.create(
                                numero_telefono=tel_extra.strip(),
                    ...
                    return redirect('registro_plataformas', id_lead=nuevo_lead.id_lead)
