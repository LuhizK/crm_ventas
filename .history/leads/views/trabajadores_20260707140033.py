...
def asegurar_cargos_basicos():
    # INYECCIÓN AUTOMÁTICA: Garantiza que el instructor del SENA no encuentre la tabla vacía
    cargos_requeridos = ['Asesor', 'Coach', 'Gerente Sede', 'Calidad', 'Gerente General']
    for nombre in cargos_requeridos:
        # get_or_create revisa si existe; si no, lo inserta en la base de datos automáticamente
