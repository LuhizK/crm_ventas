...
from ..models import Leads, Persona, ObservacionesPlataformaRiesgo, AcuerdoPago
from ..forms.editar_lead import EditarLeadForm, EditarEstadoLeadForm

def editar_lead(request, id_lead):
    # Obtenemos el lead y su persona vinculada
    lead = get_object_or_404(Leads, id_lead=id_lead)
    persona = lead.id_persona
    
    # Obtenemos el historial de observaciones ordenado por registro
