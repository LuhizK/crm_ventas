...
class PlataformasReporteForm(forms.Form):
    ...
    # EXPLICACIÓN: 'multiple': True permite al asesor seleccionar varios PDFs/Imágenes de golpe con la tecla Ctrl o Shift
    datacredito_archivos = forms.FileField(label="Reportes (Múltiples PDF/Img)", required=False, widget=forms.ClearableFileInput(attrs={'class': 'form-control', 'multiple': True}))
    ...
    equifax_archivos = forms.FileField(label="Reportes (Múltiples PDF/Img)", required=False, widget=forms.ClearableFileInput(attrs={'class': 'form-control', 'multiple': True}))
    ...
    transunion_archivos = forms.FileField(label="Reportes (Múltiples PDF/Img)", required=False, widget=forms.ClearableFileInput(attrs={'class': 'form-control', 'multiple': True}))
    ...
    experian_archivos = forms.FileField(label="Reportes (Múltiples PDF/Img)", required=False, widget=forms.ClearableFileInput(attrs={'class': 'form-control', 'multiple': True}))
    ...
    cifin_archivos = forms.FileField(label="Reportes (Múltiples PDF/Img)", required=False, widget=forms.ClearableFileInput(attrs={'class': 'form-control', 'multiple': True}))
    ...
    otro_archivos = forms.FileField(label="Reportes (Múltiples PDF/Img)", required=False, widget=forms.ClearableFileInput(attrs={'class': 'form-control', 'multiple': True}))
