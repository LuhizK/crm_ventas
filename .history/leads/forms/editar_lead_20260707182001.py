...
class EditarLeadForm(forms.ModelForm):
    # Bloqueamos campos que son llaves o identificadores
...
class EditarEstadoLeadForm(forms.ModelForm):
    # Este formulario solo se usará para guardar, pero no lo renderizaremos en el HTML si no quieres que se vea
    class Meta:
        model = Leads
        fields = [] # Vacío porque el estado ya no será editable